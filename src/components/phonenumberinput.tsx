...
export function PhoneNumberInput({ nationData, isLoading, isError, form, nameNation, nameCountryCode }: PhoneNumberInputProps) {
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <FormField
          ...
          name={nameCountryCode ? nameCountryCode : "mobile.countryCode"}
          render={({ field }) => (
        ...
        <FormField
          control={form.control}
          name={nameNation ? nameNation : "mobile.number"}
          render={({ field }) => (
